...
AKA_HELP_GUILD = "/aka guild - Toggle display of alias on/off for guild chat for the current faction on the current realm"
AKA_HELP_WHISPER = "/aka whisper - Toggle display of alias on/off for whispers for the current faction on the current realm"
AKA_HELP_CHANNEL = "/aka <number> - Toggle display of alias on/off for channels 1-10 for the current faction on the current realm"
